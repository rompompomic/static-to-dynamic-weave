      ...
      <div className="flex flex-col md:block">
        ...
        <div className="relative w-full md:absolute md:inset-0 md:flex md:justify-end">
          <img
            ...
            "
          />
          {/* затемнение на мобилках */}
          <div className="absolute inset-0 bg-black/50 md:hidden" />
        </div>

        {/* Контент (на мобилке идёт под картинкой) */}
        <div className="relative z-10 container mx-auto px-4 md:px-8 lg:px-[75px] py-8 md:py-20 max-w-full md:max-w-[430px]">
          ...
          <p className="mt-4 font-sans text-white text-base sm:text-lg leading-relaxed">
            Mūsu būvniecības uzņēmums piedāvā augstas kvalitātes pakalpojumus,
            kas aptver visu būvniecības procesu – no sākotnējām idejām līdz gataviem projektiem.
          </p>

          <button className="mt-6 inline-flex justify-center gap-2.5 px-6 py-3 bg-white items-center hover:bg-opacity-90 transition-all">
