    ...
    <section className="w-full py-12 md:py-16 lg:py-20 bg-card">
      <div className="container mx-auto px-4 md:px-8 lg:px-[75px]">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 md:gap-8 mb-12 animate-fade-in">
          {steps.map((step, index) => {
            ...
            return (
              <div
                key={index}
                className="flex flex-col items-center text-center gap-4 p-6 bg-background border border-border"
              >
        ...
        <div className="flex justify-center animate-fade-in">
          <a
            href="#kontakti"
            className="inline-flex items-center justify-center gap-2.5 px-8 py-4 bg-primary text-primary-foreground hover:opacity-90 transition-all"
          >
