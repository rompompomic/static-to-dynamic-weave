...
const ContactInfo = () => {
  return <section className="w-full py-12 md:py-16 lg:py-20 bg-white/0">
      <div className="container mx-auto px-4 md:px-8 lg:px-[75px]">
        <h2 className="font-mono font-bold text-foreground text-3xl md:text-4xl lg:text-[50px] leading-tight mb-12 text-center animate-fade-in">Контактная информация</h2>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 animate-fade-in">
          ...
          <div className="space-y-8">
            <div className="bg-background border border-border p-8">
              ...
              <div className="space-y-6">
                <a href="tel:+37120000000" className="flex items-center gap-4 group hover:text-primary transition-colors">
                ...
                <a href="mailto:info@demco.lv" className="flex items-center gap-4 group hover:text-primary transition-colors">
                  <div className="w-12 h-12 flex items-center justify-center bg-primary/10 border-2 border-primary group-hover:bg-primary/20 transition-colors">
          ...
          <div className="bg-background border border-border rounded overflow-hidden h-[460px] md:h-[500px] lg:h-[540px]">
            <iframe src="https://www.google.com/maps?q=56.97587409933749,24.25305345871394&hl=lv&z=15&output=embed" className="w-full h-full border-0" allowFullScreen loading="lazy" referrerPolicy="no-referrer-when-downgrade" title="DEMCO Location" />
          </div>
        </div>
      </div>
    </section>;
