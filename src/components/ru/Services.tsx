...
const ServicesRU = () => {
  ...
  return (
    <section id="uslugi" className="w-full py-12 md:py-16 lg:py-20 bg-[#a4a4a4]/[0.08]">
      <div className="container mx-auto px-4 md:px-8 lg:px-[75px]">
        ...
        <div className="block lg:hidden mb-12 animate-fade-in">
          ...
          <p className="font-sans text-foreground text-base md:text-lg leading-relaxed mb-6">
            Мы предлагаем широкий спектр строительных услуг — от демонтажа до благоустройства.
          </p>
          <a href="/ru/pakalpojumi" className={ctaClass}>
            <span className="text-base">Посмотреть все услуги</span>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 animate-fade-in">
          <ServiceCard
            ...
            description="Профессиональный демонтаж зданий и сооружений любой сложности с вывозом отходов."
          />
          <ServiceCard
            image={servicesRazosanasEkuDemontaza}
            title="Демонтаж промышленных объектов"
            description="Безопасный демонтаж производственных зданий, старых заводов и складов."
          />
          <ServiceCard
            image={servicesZemesDarbi}
            title="Земляные работы"
            description="Земляные работы, выравнивание, подготовка фундамента, рытье траншей и дренаж."
          />
          <ServiceCard
            image={servicesLabiekartosana}
            title="Благоустройство территории"
            description="Планировка территории, строительство дорог, укладка тротуаров, установка газонов и дренажных систем."
          />
        </div>
      </div>
    </section>
