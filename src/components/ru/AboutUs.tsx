  ...
  const advantages = [
    {
      icon: Clock,
      title: "Скорость",
      description: "Эффективное выполнение работ",
    },
    {
      icon: Shield,
      title: "Безопасность",
    ...
    },
    {
      ...
      description: "Новейшее оборудование",
    },
  ];
      ...
      <div className="container mx-auto px-4 md:px-8 lg:px-[75px]">
        ...
        <div className="max-w-4xl mb-12 animate-fade-in">
          <p className="font-sans text-foreground text-base md:text-lg leading-relaxed mb-6">
            ООО DEMCO — строительная компания с более чем 10-летним опытом
            в области демонтажа и земляных работ. Мы обеспечиваем полный цикл – от
            первоначальной оценки объекта до полного завершения работ.
          </p>
          ...
          <div className="flex flex-wrap gap-4 mb-8">
            ...
            <div className="inline-flex items-center gap-2 px-6 py-3 bg-primary/10 border border-primary/20">
              <span className="font-sans font-bold text-primary text-sm md:text-base">
                Работы в соответствии со стандартами безопасности и качества
              </span>
            </div>
          </div>
        </div>
