        ...
        >
          <div className="container mx-auto px-4 pb-8 pt-20 -mt-[56px]">
            <p className="font-sans text-white text-base leading-relaxed mb-6 text-left">
              Наша строительная компания предлагает высококачественные услуги, охватывающие весь строительный процесс – от первоначальных идей до завершенных проектов.
            </p>
