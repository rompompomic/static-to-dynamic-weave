...
const HowToApplyRU = () => {
  const steps = [
    { icon: Phone, number: "1", title: "Свяжитесь с нами", description: "Свяжитесь с нами по телефону или электронной почте." },
    { icon: FileText, number: "2", title: "Оценка объекта", description: "Оцениваем ваш объект и готовим предложение." },
    { icon: HandshakeIcon, number: "3", title: "Соглашение", description: "Договариваемся об условиях и сроках." },
    { icon: CheckCircle, number: "4", title: "Выполнение работ", description: "Выполняем работы безопасно и качественно." },
  ];
    ...
    <section className="w-full py-12 md:py-16 lg:py-20 bg-white/0">
      <div className="container mx-auto px-4 md:px-8 lg:px-[75px]">
        ...
        <div className="flex justify-center animate-fade-in">
          <a href="/ru/sadarbiba-un-kontakti" className={ctaClass}>
            <span className="font-sans font-bold text-base">Связаться с нами</span>
