...
const HowToApplyEN = () => {
  const steps = [
    { icon: Phone, number: "1", title: "Contact us", description: "Contact us by phone or email." },
    { icon: FileText, number: "2", title: "Site assessment", description: "We assess your site and prepare an offer." },
    { icon: HandshakeIcon, number: "3", title: "Agreement", description: "We agree on terms and deadlines." },
    { icon: CheckCircle, number: "4", title: "Work execution", description: "We perform work safely and professionally." },
  ];
    ...
    <section className="w-full py-12 md:py-16 lg:py-20 bg-white/0">
      <div className="container mx-auto px-4 md:px-8 lg:px-[75px]">
        ...
        <div className="flex justify-center animate-fade-in">
          <a href="/en/sadarbiba-un-kontakti" className={ctaClass}>
            <span className="font-sans font-bold text-base">Contact us</span>
