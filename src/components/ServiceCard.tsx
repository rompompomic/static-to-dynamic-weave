...
const ServiceCard = ({
  ...
  // Высота изображений
  const imgH = imageHeight || (size === "tall" ? "h-[460px] md:h-[480px]" : "h-[220px]");
  ...
  return (
    ...
    >
      ...
      {/* Контент */}
      <div className="flex flex-col justify-between px-6 py-5 flex-grow bg-white">
        <div>
          <h3 className="font-mono font-bold text-lg md:text-xl text-foreground mb-2 whitespace-normal leading-snug">
            {title}
          </h3>
