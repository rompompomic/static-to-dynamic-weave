  ...
  return <main className="bg-background overflow-x-hidden w-full min-h-screen">
      ...
      <section id="buvgruzu-izvesana" className="w-full py-12 md:py-16 bg-white/0">
        <div className="container mx-auto px-4 md:px-8 lg:px-[75px]">
          <div className="grid md:grid-cols-2 gap-8 md:gap-12 items-center animate-fade-in">
            <div className="overflow-hidden">
              <img src={buvgruzuIzvesana} alt="Būvgružu izvešana un utilizācija - būvgružu savākšana un transportēšana" className="w-full h-auto object-cover" />
            </div>
      ...
      {/* === Преимущества === */}
      <section className="w-full py-16 md:py-20 bg-[#a4a4a4]/[0.08]">
        <div className="container mx-auto px-4 md:px-8 lg:px-[75px]">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-6">
            ...
            text: "Komanda ar reāliem industriālo objektu projektiem portfelī."
                ...
                <div className="w-10 h-10 rounded-xl bg-primary/10 flex items-center justify-center mb-3 text-foreground">
                  {card.kind === "mask" ? <div className="w-8 h-8 md:w-9 md:h-9 bg-current" style={{
      ...
      {/* =========================
          CTA (усиленный)
       ========================= */}
      <section className="relative w-full overflow-hidden py-16 md:py-20 bg-white/0">
