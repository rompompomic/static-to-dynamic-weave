...
const SadarbibaUnKontaktiEN = () => {
  return <>
      <Helmet>
        <title>Cooperation and Contacts | DEMCO</title>
        <meta name="description" content="Contact DEMCO – your trusted construction partner. We offer solutions for your project." />
      </Helmet>
          ...
          <section className="w-full py-12 md:py-16 lg:py-20 bg-white/0">
            <div className="container mx-auto px-4 md:px-8 lg:px-[75px]">
              ...
              <p className="font-sans text-lg md:text-xl text-muted-foreground text-center max-w-3xl mx-auto mb-12 animate-fade-in">
                Contact us and we will offer a solution for your project.
              </p>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 md:gap-8 mb-12 animate-fade-in">
                <div className="flex flex-col items-center text-center gap-4 p-6 bg-background border border-border">
                  ...
                  <div>
                    <h3 className="font-sans font-bold text-foreground text-lg mb-2">Call</h3>
                    <p className="font-sans text-muted-foreground text-sm">Call us anytime</p>
                  </div>
                </div>
                ...
                <div className="flex flex-col items-center text-center gap-4 p-6 bg-background border border-border">
                  ...
                  <div>
                    ...
                    <p className="font-sans text-muted-foreground text-sm">Send us an email</p>
                  </div>
                </div>
                ...
                <div className="flex flex-col items-center text-center gap-4 p-6 bg-background border border-border">
                  ...
                  <div>
                    <h3 className="font-sans font-bold text-foreground text-lg mb-2">Form</h3>
                    <p className="font-sans text-muted-foreground text-sm">Fill out the online form</p>
                  </div>
                </div>
              </div>
            </div>
...
export default SadarbibaUnKontaktiEN;
